...
class WindowsTpmDaoTest(unittest.TestCase):
    def test_public_blob_conversion_produces_spki_der(self) -> None:
        ...
        der = WindowsTpmDao._public_blob_to_spki_der(base64.b64encode(blob).decode("ascii"))
    ...
    def test_normalize_signature_accepts_raw_p1363(self) -> None:
        ...
        self.assertEqual(WindowsTpmDao._normalize_signature(signature), signature)
    ...
    def test_normalize_signature_converts_der_to_raw(self) -> None:
        ...
        raw = WindowsTpmDao._normalize_signature(der)
